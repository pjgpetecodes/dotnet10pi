...
echo -e "\e[1m----------------------------------------"
echo ""
echo -e "\e[1mPete Codes / PJG Creations 2026"
echo ""
echo -e "Latest update 04/01/2026"
echo ""
...
wget -O /home/$username/dotnetdebug.sh https://raw.githubusercontent.com/pjgpetecodes/dotnet10pi/main/dotnetdebug.sh
