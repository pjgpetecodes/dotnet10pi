# Dot Net 10 with the Raspberry Pi

This is the source code to accompany my talk on Microsoft .NET 10 with the Raspberry Pi.

Tested on a Raspberry Pi 3B+ / Raspberry Pi Zero 2W, a Raspberry Pi 4 (and a Raspberry Pi 5 but with only limited functionality)!

Any Queries, contact me at;

https://www.petecodes.co.uk/contact/

Pete Gallagher / Pete Codes / PJG Creations 2026

# Blog Post

You can read the accompanying blog post for this repository here;

[Install and use .NET 10 with the Raspberry Pi](http://bit.ly/dotnet10pi)

# .NET 10 Installation on a Raspberry Pi

You can install Dot Net 10 on the Raspberry Pi in one command by executing;

```
wget -O - https://raw.githubusercontent.com/pjgpetecodes/dotnet10pi/main/install.sh | sudo bash
```
...
If you've cloned this repo, you can install Dot Net 10 by running the following in the root of the repo;
...
```
curl --output remotedebugsetup.bat https://raw.githubusercontent.com/pjgpetecodes/dotnet10pi/main/remotedebugsetup.bat && remotedebugsetup.bat
```
